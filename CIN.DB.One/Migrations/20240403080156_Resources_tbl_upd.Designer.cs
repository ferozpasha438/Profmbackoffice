...
namespace CIN.DB.One.Migrations
{
    ...
    [Migration("20240403080156_Resources_tbl_upd")]
    partial class Resources_tbl_upd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomDepartment", b =>
                {
                    ...
                    b.Property<string>("ServiceTimePeriods")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("Descriptions_Ar")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomScheduleDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("tblErpFomScheduleDetails");
                });

            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomScheduleSummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("IsSchGenerated")
                        .HasColumnType("bit");

                    b.HasKey("Id");

                    b.ToTable("tblErpFomScheduleSummary");
                });

            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomScheduleWeekdays", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("tblErpFomScheduleWeekdays");
                });

            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomServiceItems", b =>
                {
                    b.Property<string>("ServiceCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<int>("MinReqResource")
                        .HasColumnType("int");

                    b.Property<TimeSpan>("MinRequiredHrs")
                        .HasColumnType("time");
                    ...
                    b.Property<decimal>("PotentialCost")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PrimaryUnitPrice")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int>("ResourceUnitPrimary")
                        .HasColumnType("int");

                    b.Property<string>("ServiceDetails")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ServiceDetailsAr")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ServiceShortDesc")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ServiceShortDescAr")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ThumbNailImagePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<TimeSpan>("TimeUnitPrimary")
                        .HasColumnType("time");
                    ...
                    b.ToTable("tblErpFomServiceItems");
                });

            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomServiceItemsDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("Desc1Ar")
                        .HasColumnType("int");

                    b.Property<string>("Desc2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Desc2Ar")
                        .HasColumnType("int");
                    ...
                    b.ToTable("tblErpFomServiceItemsDetails");
                });

            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomServiceUnitItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("PotentialCostFactor")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PotentialUnitCost")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("tblErpFomServiceUnitItems");
                });
            ...
            modelBuilder.Entity("CIN.Domain.FomMgt.TblFomB2CJobTicket", b =>
                {
                    b.Property<string>("TicketNumber")
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime?>("ActWorkEndDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("CustRegEmail")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("ExpWorkEndDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("ForecloseBy")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("ForecloseDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("ForecloseReasonCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsConvertedToWorkOrder")
                        .HasColumnType("bit");

                    b.Property<bool>("IsCreatedByCustomer")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsLateResponse")
                        .HasColumnType("bit");

                    b.Property<bool>("IsOpen")
                        .HasColumnType("bit");

                    b.Property<bool>("IsPoRecieved")
                        .HasColumnType("bit");

                    b.Property<bool>("IsQuotationSubmitted")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("JOBookedBy")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("JODate")
                        .HasColumnType("datetime2");

                    b.Property<string>("JODeptCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("JODescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("JODocNum")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("JOImg1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("JOImg2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("JOImg3")
                        .HasColumnType("nvarchar(max)");

                    b.Property<short>("JOStatus")
                        .HasColumnType("smallint");

                    b.Property<string>("JOSubject")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("JOSupervisor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("JobMaintenanceType")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("JODeptCode");

                    b.ToTable("tblFomB2CJobTicket");
                });

            modelBuilder.Entity("CIN.Domain.FomMgt.TblFomB2CUserClientLoginMapping", b =>
                {
                    b.Property<string>("UserClientLoginCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.ToTable("tblFomB2CUserClientLoginMapping");
                });

            modelBuilder.Entity("CIN.Domain.FomMgt.TblFomJobTicketFeedBack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("tblFomJobTicketFeedBack");
                });

            modelBuilder.Entity("CIN.Domain.FomMgt.TblFomJobTicketPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("tblFomJobTicketPayment");
                });
            ...
            modelBuilder.Entity("CIN.Domain.InventorySetup.TblInvDefCategory", b =>
                {
                    ...
                    b.Property<string>("ItemCatName_Ar")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("CIN.Domain.InventorySetup.TblInvDefSubCategory", b =>
                {
                    ...
                    b.Property<string>("ItemSubCatNameAr")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomScheduleDetails", b =>
                {
                    b.HasOne("CIN.Domain.FomMgt.TblErpFomScheduleSummary", "ErpSchSumId")
                        .WithMany()
                        .HasForeignKey("SchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ErpSchSumId");
                });
            ...
            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomServiceItems", b =>
                {
                    b.HasOne("CIN.Domain.FomMgt.TblErpFomActivities", "ActCode")
                        .WithMany()
            ...
            modelBuilder.Entity("CIN.Domain.FomMgt.TblErpFomServiceItemsDetails", b =>
                {
                    b.HasOne("CIN.Domain.FomMgt.TblErpFomServiceItems", "ErpServiceCode")
                        .WithMany()
                        .HasForeignKey("ServiceCode")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ErpServiceCode");
                });
            ...
            modelBuilder.Entity("CIN.Domain.FomMgt.TblFomB2CJobTicket", b =>
                {
                    ...
                    b.HasOne("CIN.Domain.FomMgt.TblErpFomDepartment", "SysDepartment")
                        .WithMany()
                        .HasForeignKey("JODeptCode")
                        .OnDelete(DeleteBehavior.Restrict);
