...
@Component({
  selector: 'app-getcustomersreport',
  templateUrl: './getcustomersreport.component.html',
  styles: [
  ]
})
export class GetcustomersreportComponent extends ParentFomMgtComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator!: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort!: MatSort;
  displayedColumns: string[] = ['custCode', 'custName', 'custAlias', 'custAddress1', 'custCatCode', 'isActive'];
