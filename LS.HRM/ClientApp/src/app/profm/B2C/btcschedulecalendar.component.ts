...
@Component({
  selector: 'app-btcschedulecalendar',
  templateUrl: './btcschedulecalendar.component.html',
  styles: [
  ]
})
export class BtcschedulecalendarComponent extends ParentB2CComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private apiService: ApiService, private translate: TranslateService,
    private authService: AuthorizeService, private utilService: UtilityService, public dialogRef: MatDialogRef<BtcschedulelistComponent>,
