...
@Component({
  selector: 'app-btcticketsummarybyservicetype',
  templateUrl: './btcticketsummarybyservicetype.component.html',
  styles: [
  ]
})
export class BtcticketsummarybyservicetypeComponent extends ParentB2CFrontComponent implements OnInit {
  serviceList: any;
