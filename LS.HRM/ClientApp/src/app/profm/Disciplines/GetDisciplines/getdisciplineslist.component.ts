...
import { AddupdatedisciplinesComponent } from '../Sharedpages/addupdatedisciplines.component';
import { ParentFomMgtComponent } from '../../../sharedcomponent/parentfommgt.component';

@Component({
  selector: 'app-getdisciplineslist',
  templateUrl: './getdisciplineslist.component.html',
  styles: [
  ]
})
export class GetdisciplineslistComponent extends ParentFomMgtComponent implements OnInit {
  ...
  displayedColumns: string[] = ['thumbNailImage','deptCode', 'nameEng', 'nameArabic', 'deptServType', 'createdDate', 'isActive', 'Actions'];
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    ...
    this.apiService.getPagination('FomDiscipline', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
  ...
  public createlist() {
    this.openDialogManage(0, DBOperation.create, 'List Of Disciplines', 'Add', ListofdepartmentComponent);

  }
  public create() {
    this.openDialogManage(0, DBOperation.create, 'Add_New_Disciplines', 'Add', AddupdatedisciplinesComponent);

  }
  public edit(id: number) {
    console.log("id=" + id);
    this.openDialogManage(id, DBOperation.update, 'Update_Disciplines', 'Update', AddupdatedisciplinesComponent);
  }
