...
import { ParentInventoryMgtComponent } from 'src/app/sharedcomponent/parentinventorymgt.component';
import { AddupdateitemsComponent } from '../Sharedpages/addupdateitems.component';
import { ParentFomMgtComponent } from '../../../sharedcomponent/parentfommgt.component';

@Component({
  selector: 'app-getitemlists',
  templateUrl: './getitemlists.component.html',
  styles: [
  ]
})
export class GetitemlistsComponent extends ParentFomMgtComponent implements OnInit {
  ...
  public create() {
   // this.openDialogManage(0, DBOperation.create, this.translate.instant('Create_New_Issues'), '', AddupdateitemsComponent);
    this.openDialogManage();
  }

  //public edit(id: number) {
  //  //this.openDialogManage(id, DBOperation.update, this.translate.instant('Create_New_Issues'), '', AddupdateitemsComponent);
  //  this.openDialogManage();
  //}
  ...
  //  let dialogRef = this.utilService.openCrudDialog(this.dialog, AddupdateitemsComponent);
