...
import { AddupdateresourcetypesComponent } from '../Sharedpages/addupdateresourcetypes.component';
import { ParentFomMgtComponent } from '../../../sharedcomponent/parentfommgt.component';

@Component({
  selector: 'app-getresourcetypeslist',
  templateUrl: './getresourcetypeslist.component.html',
  styles: [
  ]
})
export class GetresourcetypeslistComponent extends ParentFomMgtComponent implements OnInit {
  ...
  displayedColumns: string[] = ['resTypeCode','resTypeName', 'resTypeNameAr', 'createdOn','isActive', 'Actions'];
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    ...
    this.apiService.getPagination('resourceType/getResourceTypesPaginationList', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
  ...
  private openDialogManage(id: number = 0, dbops: DBOperation, modalTitle: string, modalBtnTitle: string) {
    let dialogRef = this.utilService.openCrudDialog(this.dialog, AddupdateresourcetypesComponent);
  ...
  public create() {
    this.openDialogManage(0, DBOperation.create, this.translate.instant('Add_Resources_Types'), 'Add');
  }
  public edit(id: number) {
    this.openDialogManage(id, DBOperation.update, this.translate.instant('Update_Resource_Types'), 'Update');
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(canDelete => {
      if (canDelete && id > 0) {
        this.apiService.delete('resourceType', id).subscribe(res => {
          this.refresh();
