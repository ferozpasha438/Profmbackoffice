...
import { CreateUpdateReqReplaceEmployeeComponent } from './create-update-req-replace-employee/create-update-req-replace-employee.component';


@Component({
  selector: 'app-replace-employee',
  templateUrl: './replace-employee.component.html'
})
export class ReplaceEmployeeComponent extends ParentOptMgtComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort: MatSort;
  displayedColumns: string[] = ['customerCode', 'siteCode', 'projectCode', 'resignedEmployeeNumber','replacedEmployeeNumber', 'fromDate', 'isApproved', /*'isMerged',*/ 'Actions'];
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    this.isLoading = true;
    this.apiService.getPagination('PvReplaceResource/getPvReplaceResourceReqsPagedList', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  public create() {
    this.openDialogManage(0, DBOperation.create, 'New_Request_For_Replace_Employee', 'Add', CreateUpdateReqReplaceEmployeeComponent);
  }
  ...
  public viewRequest(id: number) {
    this.openDialogManage(id, DBOperation.create, 'Add_Resource_Request', 'View', CreateUpdateReqReplaceEmployeeComponent);
  }
