...
import { CreateUpdateSwapEmployeesComponent } from './create-update-swap-employees/create-update-swap-employees.component';

@Component({
  selector: 'app-swap-employees',
  templateUrl: './swap-employees.component.html'
})
export class SwapEmployeesComponent extends ParentOptMgtComponent implements OnInit {
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    this.isLoading = true;
    this.apiService.getPagination('PvSwapEmployees/getPvSwapEmployeesReqsPagedList', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  public create() {
    this.openDialogManage(0, DBOperation.create, 'New_Request_For_Swap_Employees', 'Add', CreateUpdateSwapEmployeesComponent);
  }

  public edit(id: number) {
    this.openDialogManage(id, DBOperation.update, 'Updating_Request_For_Swap_Employees', 'Update', CreateUpdateSwapEmployeesComponent);
  }
  ...
  public viewRequest(id: number) {
    this.openDialogManage(id, DBOperation.create, 'Request_For_Swap_Employees', 'View', CreateUpdateSwapEmployeesComponent);
  }
