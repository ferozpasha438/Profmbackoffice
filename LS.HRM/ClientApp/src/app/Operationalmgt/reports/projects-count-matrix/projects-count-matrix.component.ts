...
@Component({
  selector: 'app-projects-count-matrix',
  templateUrl: './projects-count-matrix.component.html'
})
export class ProjectsCountMatrixComponent extends ParentOptMgtComponent implements OnInit {
  form: FormGroup;
  List: Array<any> = [];
  ...
  search() {
    ...
    if (this.fromDate && this.toDate) {
      ...
      this.apiService.post('Reports/getProjectsCountMatrixReports', this.InputQuery).subscribe((res: any) => {
         ...
         this.company = res.company;
          ...
          if (this.projectSitesList.length > 0) {
            for (let i = 0; i < this.projectSitesList.length; i += 50) {
              ...
              this.apiService.post('Reports/getProjectsCountReportByProjectSites', projectsSites).subscribe((res2) => {
