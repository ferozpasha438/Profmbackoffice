...
@Component({
  selector: 'app-addupdateinventorypodistribution',
  templateUrl: './addupdateinventorypodistribution.component.html',
  styles: [
  ]
})
export class AddupdateinventorypodistributionComponent implements OnInit {
  form!: FormGroup;
  id: number = 0;
  row: any;
  ...
  constructor(private fb: FormBuilder, private apiService: ApiService,
    private authService: AuthorizeService, private utilService: UtilityService, public dialogRef: MatDialogRef<AddupdateinventorypodistributionComponent>,
  ...
  submit() {
    if (this.form.valid) {
      ...
      this.apiService.post('inventoryDistribution/createInventoryPoDistribution', this.form.value)
        .subscribe(res => {
