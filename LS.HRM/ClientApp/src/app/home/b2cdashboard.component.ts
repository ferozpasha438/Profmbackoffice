...
@Component({
  selector: 'app-b2cdashboard',
  templateUrl: './b2cdashboard.component.html',
  styleUrls: ['./home.component.css'],
})
export class B2cdashboardComponent extends ParentB2CComponent implements OnInit {
  ...
  changeSelection() {
    ...
    this.apiService.postFomUrl('FomMobB2CDashboard/GetWebDashboardDataWithFilters', this.form.value, true).subscribe((res: any) => {
  ...
  loadCustomerContract() {
    this.apiService.getFomUrl('FomCustomerContract/GetCustomerContractSelectList', true).subscribe(res => {
      if (res) {
        this.CustomerContractList = res;
      }
    });
    this.apiService.getFomUrlPagination('FomMobB2CDashboard/getCustomers', this.utilService.getQueryString(0, 1000, '', ''), true).subscribe(res => {
      if (res)
  ...
  loadProfmDashBoardData() {
    ...
    this.apiService.getFomUrl('FomMobB2CDashboard/getWebDashboardData',true).subscribe((res: any) => {
