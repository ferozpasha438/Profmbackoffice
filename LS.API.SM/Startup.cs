...
using LS.API.SM.Helper;
using LS.API.SM.HttpContext;
...
namespace LS.API.SM.HttpContext
{
...
namespace LS.API.SM
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "LS.API.SM", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"Signaturefiles")),
                RequestPath = new PathString("/Signaturefiles")
            });
            app.UseStaticFiles(new StaticFileOptions()
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"Teacherfiles")),
                RequestPath = new PathString("/Teacherfiles")
            });
