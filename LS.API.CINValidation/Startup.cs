...
using LS.API.CINValidation.Helper;
using LS.API.CINValidation.HttpContext;
...
namespace LS.API.CINValidation.HttpContext
{
...
namespace LS.API.CINValidation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "LS.API.CINValidation", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "LS.API.CINValidation v1"));
