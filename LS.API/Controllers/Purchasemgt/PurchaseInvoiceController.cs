...
{
    public class PurchaseInvoiceController : FileBaseController
    {
        public PurchaseInvoiceController(IOptions<AppSettingsJson> appSettings, IWebHostEnvironment env) : base(appSettings, env)
        {
        }
        [HttpGet]
        ...
        [HttpPost]
        public async Task<ActionResult> Create([FromBody] TblTranPurcInvoiceDto input)
        {
        ...
        private async Task<ActionResult> CreateApInvoice(TblTranPurcInvoiceDto input)
        {
