...
using LS.API.TeacherApp.HttpContext;
...
namespace LS.API.TeacherApp.HttpContext
{
...
namespace LS.API.TeacherApp
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "LS.API.TeacherApp", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "LS.API.TeacherApp v1"));
