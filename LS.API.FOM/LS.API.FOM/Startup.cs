...
using LS.API.FOM.Helper;
using LS.API.FOM.HttpContext;
...
namespace LS.API.FOM.HttpContext
{
...
namespace LS.API.FOM
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "LS.API.FOM", Version = "v1" });
            });
        }
        ...
        //    }
        //    app.UseSwagger();
        //    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "LS.API.FOM v1"));
        ...
        //    app.UseStaticFiles(new StaticFileOptions()
        //    {
        //        FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"DeptImages")),
        //        RequestPath = new PathString("/DeptImages")
        //    });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "LS.API.SM v1"));
            ...
            app.UseStaticFiles(new StaticFileOptions()
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"ActImages")),
                RequestPath = new PathString("/ActImages")
            });
