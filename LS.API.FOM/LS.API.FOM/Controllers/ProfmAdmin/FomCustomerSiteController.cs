...
namespace LS.API.OPR.Controllers.OperationsMgt
{
    ...
    public class FomCustomerSiteController : BaseController
    {

        public FomCustomerSiteController(IOptions<AppSettingsJson> appSettings) : base(appSettings)
        {
        }
