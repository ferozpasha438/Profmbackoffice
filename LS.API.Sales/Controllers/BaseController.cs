...
namespace LS.API.Sales.Controllers
{
    public class BaseController : ApiControllerBase
    {
        ...
        protected UserIdentityDto UserInfo() => new UserIdentityDto { UserId = UserId, CompanyId = CompanyId, BranchCode = BranchCode, BranchId = BranchId, Culture = Culture, ModuleCodes = "ADM,FI,FIN,INVT,PURC,SALE,OPERT,FOM" }; //ConnectionString = GetConnectionString(),
    }
