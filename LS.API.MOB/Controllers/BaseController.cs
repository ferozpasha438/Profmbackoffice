...
namespace LS.API.MOB.Controllers
{
    ...
    public class BaseController : ApiControllerBase
    {
        ...
        protected UserMobileIdentityDto UserInfo() => new UserMobileIdentityDto { UserId = UserId, EmployeeId = EmployeeId, CompanyId = CompanyId, BranchCode = BranchCode, BranchId = BranchId, Culture = Culture, SiteCode = SiteCode, ModuleCodes = "ADM,FI,FIN,INVT,PURC,SALE,OPERT,FOM" }; //ConnectionString = GetConnectionString(),
