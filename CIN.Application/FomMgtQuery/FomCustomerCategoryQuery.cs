...
{
    //#region GetAll
    //public class GetFomCustomerCategories : IRequest<PaginatedList<TblSndDefCustomerCategoryDto>>
    //{
    ...
    //public class GetFomCustomerCategoriesHandler : IRequestHandler<GetFomCustomerCategories, PaginatedList<TblSndDefCustomerCategoryDto>>
    //{
    //    private readonly CINDBOneContext _context;
    //    private readonly DBContext _context;
    //    private readonly IMapper _mapper;
    //    public GetFomCustomerCategoriesHandler(CINDBOneContext context, IMapper mapper)
    //    {
    //        _context = context;
    //        _mapper = mapper;
    //    }
    //    public async Task<PaginatedList<TblSndDefCustomerCategoryDto>> Handle(GetFomCustomerCategories request, CancellationToken cancellationToken)
    //    {
    ...
    //public class GetVehicleFuelEntryListHandler : IRequestHandler<GetFomCustomerCategoriesList, PaginatedList<TblSndDefCustomerCategoryDto>>
    //{
    //    private readonly CINDBOneContext _context;
    //    private readonly IMapper _mapper;
