...
namespace CIN.Application.PurchaseMgtDtos
{
    ...
    public class TblTranPurcInvoiceDto : PrimaryKeyDto<long>
    {
        [StringLength(50)]
        public string SpCreditNumber { get; set; }
        ...
        public List<TblTranPurcInvoiceItemDto> ItemList { get; set; } = new();
    }

    public class TblTranPurcInvoiceItemDto : PrimaryKeyDto<long>
    {
        [StringLength(50)]
        public string CreditNumber { get; set; }
    ...
    public class PrintApInvoiceDto
    {
        ...
        public TblTranPurcInvoiceDto Invoice { get; set; }
        public TblTranInvoiceDto_AR Invoice_AR { get; set; }
        public List<TblTranPurcInvoiceItemDto> InvoiceItems { get; set; }
