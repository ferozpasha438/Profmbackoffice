...
{
    [AutoMap(typeof(TblOpPvSwapEmployeesReq))]
    public class TblOpPvSwapEmployeesReqDto
    {
     ...
     public class TblOpPvSwapEmployeesReqsPaginationDto : TblOpPvSwapEmployeesReqDto
    {
