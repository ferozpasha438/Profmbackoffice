...
{
    [AutoMap(typeof(TblOpPvTransferResourceReq))]
    public class TblOpPvTransferResourceReqDto
    {
     ...
     public class TblOpPvTransferResourceReqsPaginationDto : TblOpPvTransferResourceReqDto
    {
