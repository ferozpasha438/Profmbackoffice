...
{
    [AutoMap(typeof(TblOpMonthlyRoaster))]
    public class TblOpMonthlyRoasterDto
    {
    ...
    public class OpMonthlyRoastersDto
    {
        public string CustomerCode { get; set; }
        [StringLength(20)]
        public string SiteCode { get; set; }
        ...
        public short Month { get; set; }
        public short Year { get; set; }
        public List<TblOpMonthlyRoasterDto> RoastersList { get; set; }
